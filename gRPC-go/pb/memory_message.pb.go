...
type Memory struct {
	...
	Unit                 Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=spacecode.gogrpc.Memory_Unit" json:"unit,omitempty"`
...
func init() {
	proto.RegisterEnum("spacecode.gogrpc.Memory_Unit", Memory_Unit_name, Memory_Unit_value)
	proto.RegisterType((*Memory)(nil), "spacecode.gogrpc.Memory")
}
...
var fileDescriptor_c0c7f919ccc765da = []byte{
	...
	0x17, 0x12, 0x28, 0x2e, 0x48, 0x4c, 0x4e, 0x4d, 0xce, 0x4f, 0x49, 0xd5, 0x4b, 0xcf, 0x4f, 0x2f,
	0x2a, 0x48, 0x56, 0xda, 0xc8, 0xc8, 0xc5, 0xe6, 0x0b, 0x56, 0x2a, 0x24, 0xc2, 0xc5, 0x5a, 0x96,
	...
	0xff, 0xff, 0x8f, 0x42, 0x65, 0x8c, 0xea, 0x00, 0x00, 0x00,
}
