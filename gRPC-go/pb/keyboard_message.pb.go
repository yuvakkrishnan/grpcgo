...
type Keyboard struct {
	Layout               Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=spacecode.gogrpc.Keyboard_Layout" json:"layout,omitempty"`
...
func init() {
	proto.RegisterEnum("spacecode.gogrpc.Keyboard_Layout", Keyboard_Layout_name, Keyboard_Layout_value)
	proto.RegisterType((*Keyboard)(nil), "spacecode.gogrpc.Keyboard")
}
...
var fileDescriptor_8fd4226b8635fe5d = []byte{
	...
	0x4f, 0x2f, 0x2a, 0x48, 0x56, 0x9a, 0xc5, 0xc8, 0xc5, 0xe1, 0x0d, 0x55, 0x2c, 0x64, 0xc9, 0xc5,
	...
	0x12, 0x1b, 0xd8, 0xed, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x02, 0xcd, 0x05, 0x4e, 0xd5,
	0x00, 0x00, 0x00,
}
